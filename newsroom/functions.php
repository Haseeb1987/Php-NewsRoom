...
if($row_count>=1){
 ...
 ?>
			...
			<? } ?>
                ...
                <div class="chat_user"><a href="http://www.jyrno.com/profile/index/u/<?php echo $user['id']; ?>" target="_blank"  <?php if((time()-$user['chat_login_time']) < 30) { echo 'class="blink"'; } ?>><?php echo $full_name;?></a>                <div class="status_user">
...
<a title="" style=" cursor:help" class="info_chatroom" id="<?php echo $chat_group['chatroom_id']; ?>"><img src="images/info.png" width="20" height="20" /></a>
...
?>
			<div class="chat_group">
    		<div class="chatroom_name" id="prc<?php echo $chat_group['chatroom_id']; ?>"><a href="#" id="<?php echo $chat_group['chatroom_id']; ?>" rel="<?php echo $chat_group['created_by']; ?>" class="private_chatroom"><?php echo $chat_group['name'] ;?></a><div style="float:right"><input type="button" name="accept" class="accept" value="accept" rel="<?php echo $chat_group['chatroom_id']; ?>" /><input type="button" class="reject" name="reject" value="reject" rel="<?php echo $chat_group['chatroom_id']; ?>"/></div></div>  
             </div>   
		<?php }else{ ?>
		<div class="chat_group">
    		<div class="chatroom_name" id="prc<?php echo $chat_group['chatroom_id']; ?>"><a href="#" id="<?php echo $chat_group['chatroom_id']; ?>" rel="<?php echo $chat_group['created_by']; ?>" class="private_chatroom"><?php echo $chat_group['name'] ;?></a> <div style="float:right">
